	...
	<div class="container_12">
		...
		<div id="header">
			...
			<ul id="nav">
				...
				<li>
				<a class="current_page" href="about">About</a>
				</li>
				<li>
		...
		<div class="grid_7 line">
			<h2>About</h2>
			<p>Cabana Mira is a unique ski chalet, purpose built to provide comfortable, affordable accommodation for its guests. Primarily catering for those 			visiting Borsa for its beautiful ski slopes, the chalet is the perfect setting for a great getaway, with its warm and welcoming atmosphere it's sure 			to make your trip a memorable one.</p>

			<p>Built in the Spring of 2010, Cabana Mira is the product of an Irish - Romanian partnership. The chalet was built by people passionate 			about creating awareness of this beautiful part of the world and making it more accessible to those wishing to visit. Built and maintained by individuals, Cabana Mira can offer guests a truly personal experience.</p>
			<p>The chalet takes bookings from groups or families all year round. On special request a booking for part of the house can be made. If you'd like to make a booking just get in <a href="contact">contact</a>.</p>
			<br/>
			...
			<script language="JavaScript">
				...
				for(i=0;i<test.length;i++){
					...
					document.write("</em></p><br/>");
				}
			</script>
		</div>
		<div class="grid_4 push_1">
			<img src="images/house_bw.jpg" width="300" height="300" alt="cabana borsa"/>
		</div>	
