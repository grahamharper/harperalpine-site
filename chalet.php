	...
	<div class="container_12">
		...
		<div id="header">
			...
			<ul id="nav">
				...
				<li>
				<a class="current_page" href="chalet">The Chalet</a>
				</li>
				<li>
		...
		<div class="grid_7 line">
			<h2>The Chalet</h2>
			<p>Cabana Mira is a beautiful timber chalet built to accommodate large groups and families. It has plenty of rooms and all the facilities needed for a comfortable and enjoyable stay. The chalet offers:</p>
			<p>
				<ul>
					<li>2 double rooms</li>
					<li>4 twin rooms</li>
					<li>All rooms en suite</li>
					<li>A large living room</li>
					<li>A central wood burning stove</li>
					<li>Dining area</li>
			...
			<p>
				The house is built on it's own picturesque plot of land surrounded by a spacious green lawn. Located just 4km from the ski slopes and 6km from the centre of Borsa everything you would need is nearby. Visit our <a href="gallery">gallery</a> for more photos and details about the chalet.
			</p>
		</div>
		<div class="grid_4 push_1">
			<img src="images/image_grid.jpg" width="300" height="496" alt="cabana borsa"/>
		</div>	
