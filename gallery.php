...
//$filepath = "images/gallery/living/"; //the path to the files
$filepath = array("images/gallery/living/","images/gallery/kitchen/","images/gallery/bedrooms/","images/gallery/outside/");
...
$myFiles = array(
	...
	{
		$handle = opendir($filepath[$i]);
	
	while (false != ($file = readdir($handle))) {
	
		//ignore other random site files that might be in the directory
		if ($file != "." && $file != ".." && $file != ".DS_Store" && $file != "index.html" && $file != "index.htm" && $file != "index.php") { 
	
			//add the filenames to an array
			array_push($myFiles[$i],$filepath[$i].$file);
...
$filepath_thumbs = array("images/gallery/living_thumbs/","images/gallery/kitchen_thumbs/","images/gallery/bedrooms_thumbs/","images/gallery/outside_thumbs/");
...
$myThumbs = array(
	...
	for($i=0;$i<count($filepath_thumbs);$i++)
	{
		$handle = opendir($filepath_thumbs[$i]);
	...
	while (false != ($file = readdir($handle))) {
		...
		if ($file != "." && $file != ".." && $file != ".DS_Store" && $file != "index.html" && $file != "index.htm" && $file != "index.php") { 
			...
			//add the filenames to an array
			array_push($myThumbs[$i],$filepath_thumbs[$i].$file);
	...
	<div class="container_12">
		...
		<div id="header">
			...
			<ul id="nav">
				...
				<li>
				<a class="current_page" href="gallery">Gallery</a>
				</li>
				<li>
		...
		<div id="living" class="grid_4 line">
			<h3>Living Areas</h3>
		</div>
		<div class="grid_8"><!--the thumbnail holder-->
			<?php		
			
				for($i = 0;$i < count($myFiles[0]);$i++)
				{	
					echo '<div class="grid_2 thumb';
					if($i % 4==0){echo ' alpha';}
					else if($i % 4==3){echo ' omega';}
					echo '"><a href="'.$myFiles[0][$i].'" rel="group"><img src="'.$myThumbs[0][$i].'" width="140" height="140"/></a></div>';

					
				}				
			?>
		</div><!--close thumbnail holder-->	
		
		<div id="kitchen" class="grid_4 line">
			<h3>Kitchen</h3>
		</div>
		<div class="grid_8"><!--the thumbnail holder-->
			<?php		
				...
				{	
					...
					echo '"><a href="'.$myFiles[1][$i].'" rel="group"><img src="'.$myThumbs[1][$i].'" width="140" height="140"/></a></div>';
		...
		<div id="bedrooms" class="grid_4 line">
			<h3>Bedrooms</h3>
		</div>
		<div class="grid_8"><!--the thumbnail holder-->
			<?php		
			
				for($i = 0;$i < count($myFiles[2]);$i++)
				{	
					echo '<div class="grid_2 thumb';
					if($i % 4==0){echo ' alpha';}
					else if($i % 4==3){echo ' omega';}
					echo '"><a href="'.$myFiles[2][$i].'" rel="group"><img src="'.$myThumbs[2][$i].'" width="140" height="140"/></a></div>';
		...
		<div id="outside" class="grid_4 line">
			<h3>Outside</h3>
		</div>
		<div class="grid_8"><!--the thumbnail holder-->
			<?php		
			
				for($i = 0;$i < count($myFiles[3]);$i++)
				{	
					echo '<div class="grid_2 thumb';
					if($i % 4==0){echo ' alpha';}
					else if($i % 4==3){echo ' omega';}
					echo '"><a href="'.$myFiles[3][$i].'" rel="group"><img src="'.$myThumbs[3][$i].'" width="140" height="140"/></a></div>';
...
-->
	...
	<div class="grid_2 top prefix_5"><a href="#header">Top</a></div>
